...
frappe.query_reports["Item-wise Sales & Stock Movement"] = {
	"filters": [
		{
			fieldname: "from_date",
			label: __("From Date"),
		...
		},
		{
			...
			on_change: function() {
				...
				if(item_code) {
					frappe.call({
						method: "sabaa.sabaa.report.item_wise_sales_&_stock_movement.item_wise_sales_&_stock_movement.get_item_uoms",
